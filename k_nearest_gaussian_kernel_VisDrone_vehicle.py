...
if __name__=="__main__":
    root = '/media/whitney/datafile/PhD_firstyear_spring/ICCV_workshop/VisDrone/'
    ...
    for img_path in img_paths:
        ...
        np.save(img_path.replace('.jpg','.npy').replace('images','ground_truth_vehicle'), k)
