...
class cdpeopleDataset(data.Dataset):
    def __init__(self, setname, args):
        ...
        if setname == 'train':
            self.img_path = "../ICCV_workshop/VisDrone/new_separate/train/rf_image_people"
            self.gt_path = "../ICCV_workshop/VisDrone/new_separate/train/rf_GT_people"
        else:
            self.img_path = "../ICCV_workshop/VisDrone/new_separate/test/rf_image_people"
            self.gt_path = "../ICCV_workshop/VisDrone/new_separate/test/rf_GT_people"
        self.phase = setname
