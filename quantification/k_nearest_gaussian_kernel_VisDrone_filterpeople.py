...
if __name__=="__main__":
    ...
    testcase = os.path.join(root,'testcase','images')
    ...
    for img_path in img_paths:
        ...
        if kn > 10:
            ...
            np.save(img_path.replace('.jpg','.npy').replace('images','filter_GT_people'), k)
            misc.imsave(img_path.replace('images','filter_image_people'), img)
